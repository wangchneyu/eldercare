...
// This parser handles the simulator message format defined in plan.md §五.
// It parses the inner "payload" field and converts to the appropriate ParsedEvent type.
//
// For VITAL_SIGN: fields are snake_case (heart_rate, respiratory_rate, body_movement, bed_status)
// For SOS: fields are camelCase (triggerType, batteryLevel, location, etc.)
// For HEARTBEAT: just deviceId confirmation, no extra payload
//
// The parser extracts known fields but also preserves the raw payload Map for forwarding.
