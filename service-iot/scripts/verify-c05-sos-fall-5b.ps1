...
& cmd /c "$MavenCommand -pl service-iot -am -Dtest=C05SosElderAndFall5bIntegrationTest -Dsurefire.failIfNoSpecifiedTests=false -Diot.rocketmq.5b.sos-fall.enabled=true -Drocketmq.name-server=$NameServer test" 2>$null
